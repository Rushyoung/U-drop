...
import { useContextMenu, type MenuOption } from '../../utils/contextMenu';
...
const activeShareHash = ref<string | null>(null);
const activeShareName = ref<string | null>(null);
const activeAttachmentId = ref<number | null>(null);

const handleShareRequest = (attId: number, hash: string, name: string) => {
...
const confirmShare = async (params: { expire_in: number | null, max_uses: number, display_name: string }) => {
...
const isSupportedThumbnail = (mime?: string | null) => {
...
const activeImageHash = ref<string | null>(null);
const activeImageName = ref<string | null>(null);
...
const handleImageClick = async (attId: number, hash: string, name: string) => {
