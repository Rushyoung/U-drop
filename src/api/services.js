...
export const MessageService = {
  ...
  restore: (id) =>
    client.post(`/messages/${id}/restore`),

  getTrash: () =>
    client.get('/messages/trash'),

  emptyTrash: () =>
    client.delete('/messages/trash/empty'),
};
...
export const ShareService = {
  create: (data) =>
    client.post('/share/file', data),

  list: () =>
    client.get('/share/list'),

  revoke: (shareId) =>
    client.delete(`/share/${shareId}`),
...
export const SystemService = {
  ...
  setup: (data) =>
    client.post('/system/setup', data),
};

export const ManageService = {
  getSettings: () =>
    client.get('/manage/settings'),
  updateSettings: (data) =>
    client.put('/manage/settings', data),
  listUsers: () =>
  ...
  deleteUser: (userUuid) =>
    client.delete(`/manage/users/${userUuid}`),
  factoryReset: (data) =>
    client.post('/manage/factory_reset', data),
};
